    ...
    return (
			<div className="grow w-full">
				<div className="flex flex-row gap-2">
					<div className="sm:w-[250px] md:w-[270px] lg:w-[350px] h-[50px] bg-white dark:bg-[#1b1a1f] md:ml-[20px] mt-[30px] rounded-full">
						<form
						...
						>
							...
							/>
							<button className="ml-auto p-[10px] mr-[7px] bg-[#FF7272] dark:bg-[#e06161] rounded-full hover:bg-[#e76464] dark:hover:bg-[#be4f4f]">
				...
				<h1 className="font-semibold ml-[20px] mt-[30px] text-[1.3rem] text-[#FF7272] hover:underline w-fit">
					{welcomePhrases[rndIndex]}
				</h1>
				...
				<div className="flex sm:flex-row xsm:flex-col mt-[15px]">
						...
						{animals.map((anm) => {
							return (
								<button
									...
									className={`flex flex-row pl-[5px] lg:py-[5px] lg:pr-[20px] xl:pr-[25px] ml-[10px] transition-all duration-200 xsm:h-[50px] xsm:pr-[5px] 
                                ${
																	!active[anm.target]
																		? "bg-white hover:bg-[#d6d6d6] dark:bg-[#1b1a1f] dark:hover:bg-[#111114]"
																		: "bg-[#FF7272] dark:bg-[#e06161] hover:bg-[#e76464]"
																} rounded-full items-center group`}
								>
									<span
										className={`${
											!active[anm.target]
												? "bg-[#EFF0F3] group-hover:bg-[#e1e2e6] dark:bg-[#27242C] dark:group-hover:bg-[#1b1a1f]"
												: "bg-[#d35959] group-hover:bg-[#bb4d4d] dark:bg-[#b94f4f]"
										} p-[7px] rounded-full`}
									>
										{anm.emoji}
									</span>
									<span
										className={`lg:text-[0.8rem] xl:text-[1rem] lg:ml-[7px] xl:ml-[15px] font-semibold group-hover:text-white xsm:hidden lg:inline ${
											!active[anm.target]
												? "text-[#979b9c] dark:text-[#abb0b1]"
												: "text-white"
										}`}
									>
										{anm.type}
					...
					<button
						onClick={displayShelters}
						className="flex flex-row sm:ml-auto xsm:ml-[20px] mt-[20px] hover:underline underline-offset-4 decoration-[#979b9c] sm:mr-[20px] md:mr-[30px] xl:mr-[60px]"
					>
						<h2 className="text-[#979b9c] dark:text-[#afb3b4] lg:text-[0.9rem] xl:text-[1rem]">
							Browse Shelters
							<strong className="font-semibold text-[#FF7272]">
								{" "}
								({shelters?.length})
							</strong>
						</h2>
				...
				{open && (
					<ModalShelters
						setOpen={setOpen}
						search={search.submit ? search.query : null}
					/>
				)}
