                ...
                <div className="px-[25px] relative bottom-[10px]">
                    ...
                    <div className="flex flex-row">
                        {listAnimals.includes("Dogs") ? (
                            <div className="bg-[#4b5bf0] w-[30px] h-[30px] flex items-center rounded-full outline outline-2 outline-white hover:animate-spin">
                                <FaDog className="text-white mx-auto" />
                            </div>
                        ) : null}

                        {listAnimals.includes("Cats") ? (
                            <div className="bg-[#4b5bf0] w-[30px] h-[30px] ml-[-2px] flex items-center rounded-full outline outline-2 outline-white hover:animate-spin">
                    ...
                    <div className="flex flex-row">
                        <h1 className="font-semibold mt-[5px] text-[1.2rem] text-[#838788]">{name.length > 15 ? name.slice(0, 14) + "..." : name}</h1>
                    ...
                    <div className="flex flex-row mt-[15px]">
                        ...
                        <h2 className="flex font-semibold ml-auto text-[#979b9c]">{moneyFormat(goal)}</h2>
                    </div>

                    <div className="flex flex-row mt-[15px]">
                        <h2 className="flex text-[#ACB1B2]">Total Collected:</h2>
                        <h2 className="flex font-semibold ml-auto text-[#979b9c]">{moneyFormat(budget)}</h2>
                    </div>
                </div>
            </div>
        </Link>
