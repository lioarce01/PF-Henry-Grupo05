          ...
          <div className="w-full">
              ...
              <div className='flex flex-row justify-end w-full items-'>
                ...
                }
                {
                  likes > 1 ? <p className='p-1 text-sm text-gray-700'>{likesActuals} likes</p>
                    : likes === 1 ? <p className='p-1 text-sm text-gray-700'>{likesActuals} like</p>
                      : null
                }
              </div>
            </button>
            <div className="flex items-center justify-end pt-2 mt-2 border-t border-gray-400">
              <div className="flex mr-4 text-sm text-gray-700">
                {
                  like
                    ? <button className='flex flex-row items-center border border-[#fffcf7] hover:border hover:border-[#FAF2E7] py-1 px-3 rounded-md hover:bg-[#FAF2E7] transition duration-300e' onClick={toggleLike}>
                      ...
                      <p className='pl-1 text-lg font-semibold text-gray-800'>Like</p>
                    </button>
              ...
              <div className="flex mr-2 text-sm text-gray-700">
                <button onClick={() => setIsOpen(true)} className='flex flex-row items-center pr-4 border border-[#fffcf7] hover:border hover:border-[#FAF2E7] py-1 px-3 rounded-md hover:bg-[#FAF2E7] transition duration-300'>
