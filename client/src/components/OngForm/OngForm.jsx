...
const OngForm = () => {
  ...
  const onSubmit = async () => {
    if (image.length) {
      await createShelter({ ...values, profilePic: image }).then(res => alert('Shelter Created')).catch(() => alert('error'));
      navigate('/home')
    }
  }
          ...
          <div className='flex flex-row w-full p-14 h-full' >
            <div className='flex flex-col w-full h-full'>
              <div className="mb-6 w-full ">
                <label className="block mb-2 text-xl font-medium text-black dark:text-black after:content-['*'] after:ml-0.5 after:text-red-500">Name</label>
              ...
              <div className="mb-6 w-full">
                <label className="block mb-2 text-xl font-medium text-black dark:text-black after:content-['*'] after:ml-0.5 after:text-red-500">Country</label>
              ...
              <div className="mb-6 w-full">
                <label className="block mb-2 text-xl font-medium text-black dark:text-black after:content-['*'] after:ml-0.5 after:text-red-500">City</label>
                <div className="flex items-center">
              ...
              <div className="mb-6 w-full">
                <label className="block mb-2 text-xl font-medium text-black dark:text-black after:content-['*'] after:ml-0.5 after:text-red-500">Address</label>
                <div className="flex items-center">
              ...
              <div className="mb-6 w-full">
                <label className="block mb-2 text-xl font-medium text-black dark:text-black after:content-['*'] after:ml-0.5 after:text-red-500">Goal</label>
                <div className="flex items-center">
              ...
              <div className="mb-6 w-full">
                <label className="block mb-2 text-xl font-medium text-black dark:text-black">Animals: </label>
                <div className="flex items-center">
                  <select name="animals" onChange={handleChange} onBlur={handleBlur} className="bg-gray-50 w-2/4 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg[#EEEEE6]  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option disabled selected>Select the types of animals you help</option>
                    <option value='All' name='All' >All</option>
                    <option value='Dogs' name='Dogs' >Dogs</option>
                    <option value='Cats' name='Cats' >Cats</option>
                    <option value='Wild Animals' name='Wild Animals' >Wild Animals</option>
                    <option value='Farm Animals' name='Farm Animals' >Farm Animals</option>
                  </select>
                </div>
              </div>
            </div>
