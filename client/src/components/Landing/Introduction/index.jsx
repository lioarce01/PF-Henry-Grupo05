      ...
      <div className="ml-1/3max-w-max">
        <div className="flex flex-row items-center mx-auto max-w-7xl 2xl:gap-x-28">
          ...
          <div className="relative top-[-100px] flex flex-col ml-[-60px]">
            <h1 className="mb-8  text-4xl font-[500] text-[#000] md:text-7xl lg:text-[4.5rem] lg:w-[600px]">
            ...
            <div className="mt-0 lg:mt-6 max-w-7xl sm:flex">
              <div className="mt-3 rounded-lg sm:mt-0">
                ...
                <button className="bg-none h-[60px] w-[200px] drop-shadow-md ml-5 rounded-xl border-2 border-[#F87171] text-[#3D190C] font-[700] hover:bg-[#F87171] hover:text-white duration-500 active:bg-[#7c4737]">Learn more</button>
              </div>
            </div>
          </div>
