	...
	return (
		<div className="bg-[#FAF2E7]">
			...
			<div className="flex flex-col items-center h-full min-h-screen pt-16">
				...
				<div className="flex flex-col w-[90%] md:w-[640px] lg:w-[768px] max-h-[800px] overflow-y-scroll py-2 px-4 my-4 bg-[#fffcf7] rounded-md items-center">
					<div className="mt-2">
						{user.posts?.length < 1 ? (
							<div className="my-10">
				...
				<div className="flex flex-col w-[90%] md:w-[640px] lg:w-[768px] h-auto max-h-[800px] py-2 px-4 my-4 bg-[#fffcf7] rounded-md">
					<div className="flex flex-col mt-2 overflow-y-scroll ">
						{following?.length < 1 && (
							<div className="my-10">
								<h1 className="text-xl font-bold text-[#462312]">
									You don't have any shelter in your list!
								</h1>
							</div>
						)}
						{following?.length > 0 &&
